      ...
      <div className="py-10 cards w-full flex flex-col md:flex-row gap-10">
        ...
        >
          <h1 className="mb-4 flex gap-2 items-center tracking-wide">
            <span className="w-2 h-2 bg-zinc-50 rounded-full"></span> ODESZA
          </h1>
          ...
          <div className="card w-full h-[300px] flex items-center rounded-xl overflow-hidden">
            <img
              ...
              src="https://i.scdn.co/image/ab67616d0000b2738698d68e525fec9c6143d6ed"
              alt="featured"
            />
          </div>
        </motion.div>
        ...
        >
          <h1 className="mb-4 flex gap-2 items-center tracking-wide">
            <span className="w-2 h-2 bg-zinc-50 rounded-full"></span> brakence
          </h1>
          <h1 className="absolute flex overflow-hidden text-[#E2E2B6] right-1/2 sm:right-full translate-x-1/2 top-1/2 -translate-y-1/2 z-10 text-8xl font-NueueMontreal leading-none tracking-tighter">
            {"brakence".split("").map((item, index) => (
              <motion.span
                initial={{ y: "100%" }}
                animate={cards[1]}
                transition={{ ease: [0.22, 1, 0.36, 1], delay: index * 0.06 }}
          ...
          <div className="card w-full h-[300px] flex items-center rounded-xl overflow-hidden">
            <img
              className="w-full h-auto object-cover hover:scale-105 transition-all"
              src="https://i.scdn.co/image/ab67616d0000b273788291d70768119470b921db"
              alt="featured"
            />
          </div>
        </motion.div>
